const products = [
  { name: "Plain Royale", tag: "Grade A+", img: "https://images.unsplash.com/photo-1536628218485-db204a439c77?q=80&w=800" },
  { name: "Roasted Gold", tag: "Crunchy", img: "https://images.unsplash.com/photo-1623114112815-56543b355866?q=80&w=800" },
  { name: "Exotic Flavors", tag: "Spiced", img: "https://images.unsplash.com/photo-1590502593457-4632a6778f65?q=80&w=800" },
  { name: "Elite Combos", tag: "Gift Pack", img: "https://images.unsplash.com/photo-1596560548464-f010549b84d7?q=80&w=800" },
];

export default function SignatureCollection() {
  return (
    <section className="py-24 bg-[#faf9f6]"> {/* Matches Hero Background */}
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          <button className="px-8 py-4 bg-white border-2 border-slate-100 text-slate-900 font-bold rounded-2xl hover:bg-emerald-50 hover:border-emerald-200 transition-all shadow-sm">
          ...
          {products.map((item, i) => (
            <div key={i} className="group relative flex flex-col">
              ...
              <div className="mt-6 text-center lg:text-left">
                ...
                <p className="text-slate-400 text-sm font-medium mt-1">Wholesale & Retail Packs</p>
